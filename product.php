...
<div class="main-container">
    <div id="content">
      <!--  <img src="image/fwd/logo2.jpg" alt="slider1"
        ...
        <div class="content-main-w" id="best_product">
            <div class="container">
                            ...
                            <div class="ltabs-wrap">
                                            ...
                                            <ul class="ltabs-tabs cf">
                                                <li class="ltabs-tab tab-sel" data-category-id="34"
                                                    data-active-content=".items-category-34"> <!--<span
                                                                class-tab-label">Brake Parts</span> --></li>
                                ...
                                <div class="row">
                                    <div class="col-md-4 text-center">
                                        ...
                                        <label><b>MS Machine Screw</b></label>
                                    </div>
                                    <div class="col-md-4 text-center">
                                        ...
                                        <label for="" style="margin-top: 30px"><b>MS Sheet Metal Screw</b></label>
                                    </div>
                                    <div class="col-md-4 text-center">
                                        <div class="product-layout product-grid" style="margin-bottom: 20px">
                                            <div class="product-item-containersss item--static" >
                                ...
                                <div class="row">
                                    <div class="col-md-6 text-center">
                                        ...
                                        <label for=""><b>MS Set Screw</b></label>
                                    </div>
                                    <div class="col-md-6 text-center">
                                        <div class="product-layout product-grid" style="margin-bottom: 20px">
                                            <div class="product-item-containersss item--static" >
                                        ...
                                        <label for=""><b>MS Self-Drilling Screw</b></label>
                                    </div>
                                </div>
                                                ...
                                                <div class="item">
                                                    ...
                                                    <div class="product-layout product-grid">
                                                        <div class="product-item-containersss item--static" >
                                                            <div class="left-block">
                                                                <div class="product-image-container second_img">
                                                                    <img src="image/fwd/image003_1.png"
                                                                         alt="image1">
                                                                    <p>Binding Screw</p>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="item">
                                                    <div class="product-layout product-grid" style="margin-bottom: 20px">
                                                        <div class="product-item-containersss item--static" >
                                                            <div class="left-block">
                                                                <div class="product-image-container second_img">
                                                                    <img src="image/fwd/image001_9.jpg"
                                                                         alt="image1">
                                                                    <p>Wooden Screw</p>
                                                                </div>
                                                            </div>
